...
| 제한사항          | 설명                                                                                                                                                                                                     | 상태         |
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| **한자 OCR**      | 한글/한자 혼용 문서에서 한자가 깨질 수 있음                                                                                                                                                              | 🔧 개선중    |
| **목차 추출**     | 목차가 없거나 특이한 구조면 추출 실패 가능. 특이사항이 없어 보이는 목차도 일부 실패하는 케이스 있음                                                                                                      | 🔧 개선중    |
| **세로쓰기 문서** | 페이지 번호가 한자인 오래된 세로쓰기 문서 (장기적으로 지원 대상이지만, 현재는 계획에 없음)                                                                                                               | 📅 장기 목표 |
| **자동화 범위**   | 완전 자동화 미지향. 100% 수동→90% 자동화가 목표. 페이지 맵핑/목차 추출은 파이프라인 근간이나 100% 자동화 불가—보편적 패턴에 집중. 이후 단계는 100%에 가까운 자동화 지향. 특이 케이스는 하이브리드로 대응 | 🔧 개선중    |
