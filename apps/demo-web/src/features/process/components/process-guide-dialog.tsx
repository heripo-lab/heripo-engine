...
const TEXT = {
  ko: {
    ...
    time: '문서 크기와 복잡도에 따라 {{bold}}10분~1시간 이상{{/bold}} 소요될 수 있습니다.',
    browserClose:
  ...
  en: {
    ...
    time: 'Depending on document size and complexity, processing may take {{bold}}10 minutes to over 1 hour{{/bold}}.',
    browserClose:
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3 rounded-md border p-3">
            ...
            <div className="text-sm">{renderBold(t.time)}</div>
          </div>
